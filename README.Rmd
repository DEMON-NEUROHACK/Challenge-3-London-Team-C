...
The LINCS data portal was queried using the top-10 highest ranked genes as the "up" genes, and the bottom-10 lowest ranked genes as the "down" genes. This returned enrichment for thousands of drug-associated signatures, from which we took the top 10 most highly enriched drugs.  
...
![](figures/Insertion rankings.png)
...
We first used AlphaFold2 to generate a crystal sturcture of NAA10: [figure below](https://github.com/DEMON-NEUROHACK/Challenge-3-London-Team-C/blob/main/figures/docking/AF2_NAA10_prediction.png). 
...
Top candidates nominated by similarity analysis with Geneshot-derived gene signatures for 5k+ drugs.
