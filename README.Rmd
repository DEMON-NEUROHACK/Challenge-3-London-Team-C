...
1.  Estimate the size of repeats within a genome using [Expansion Hunter](https://github.com/Illumina/ExpansionHunter) by searching through a BAM/CRAM file for reads that span, flank, and are fully contained in each repeat.
2. 
3.  
